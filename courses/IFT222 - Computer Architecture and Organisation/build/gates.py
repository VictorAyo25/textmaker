"""House-style gates for the IFT222 manual. A violation stops the build.
...
These encode the workspace's hard rules:
  ...
  3. The reserved colour (electric violet #6d28d9) means MUST MEMORISE and nothing
...
def run_gates(html):
    ...
    for m in re.finditer(r'style="[^"]*#6d28d9', html, re.I):
        fails.append('reserved colour #6d28d9 used in an inline style; it belongs '
