...
TOC = [
    ...
    (0, 'Objective Section · Both Tests, Every Option Explained',
        'Objective Section', 'Both Tests,<br>Every Option Explained'),
    ...
    (2, 'Architecture versus Organization',
        'Objective Section', 'Architecture versus Organization'),
    (2, 'Instruction Set Architecture and Microarchitecture',
        'Objective Section', 'Instruction Set Architecture and Microarchitecture'),
    (2, 'Number Systems and Codes',
        'Objective Section', 'Number Systems and Codes'),
    (2, 'Signed Numbers and Complements',
        'Objective Section', 'Signed Numbers and Complements'),
    (2, 'Floating Point and IEEE 754',
        'Objective Section', 'Floating Point and IEEE 754'),
    (2, 'Instruction Types and Formats',
        'Objective Section', 'Instruction Types and Formats'),
    (2, 'Addressing Modes',
        'Objective Section', 'Addressing Modes'),
    (2, 'Memory, Buses and the Processor',
        'Objective Section', 'Memory, Buses and the Processor'),
    (2, 'Performance, RISC and CISC',
        'Objective Section', 'Performance, RISC and CISC'),
    (2, 'Von Neumann, Harvard and Image Data',
        'Objective Section', 'Von Neumann, Harvard and Image Data'),
