...
TOC = [
    ...
    (0, 'Module One · Introduction to Python Programming',
        'Module One', 'Introduction to<br>Python Programming'),
    (2, 'Unit 1 · Overview of Python', 'Module One &middot; Unit 1', 'Overview of Python'),
    (2, 'Unit 2 · Setting Up Python', 'Module One &middot; Unit 2', 'Setting Up Python'),

    (0, 'Module Two · Python Basics and Syntax',
        'Module Two', 'Python Basics<br>and Syntax'),
    (2, 'Unit 1 · Python Language Syntax', 'Module Two &middot; Unit 1', 'Python Language Syntax'),
    (2, 'Unit 2 · Variables and Data Types', 'Module Two &middot; Unit 2', 'Variables and Data Types'),
    (2, 'Unit 3 · Python Operators', 'Module Two &middot; Unit 3', 'Python Operators'),
    (2, 'Unit 4 · Working with Strings', 'Module Two &middot; Unit 4', 'Working with Strings'),

    (0, 'Module Three · Control Flow and Data Structures',
        'Module Three', 'Control Flow and<br>Data Structures'),
    (2, 'Unit 1 · Decision Making in Python', 'Module Three &middot; Unit 1', 'Decision Making in Python'),
    (2, 'Unit 2 · Loops: Repetition and Branching', 'Module Three &middot; Unit 2', 'Loops: Repetition and Branching'),
    (2, 'Unit 3 · Lists and Tuples', 'Module Three &middot; Unit 3', 'Lists and Tuples'),
    (2, 'Unit 4 · Sets and Dictionaries', 'Module Three &middot; Unit 4', 'Sets and Dictionaries'),

    (0, 'Module Four · Functions, Modules and File Handling',
        'Module Four', 'Functions, Modules<br>and File Handling'),
    (2, 'Unit 1 · Functions in Python', 'Module Four &middot; Unit 1', 'Functions in Python'),
    (2, 'Unit 2 · Modules and Packages', 'Module Four &middot; Unit 2', 'Modules and Packages'),
    (2, 'Unit 3 · File Handling in Python', 'Module Four &middot; Unit 3', 'File Handling in Python'),
    (2, 'Unit 4 · Exception Handling', 'Module Four &middot; Unit 4', 'Exception Handling'),

    (0, 'Module Five · Databases and GUI Development',
        'Module Five', 'Databases and<br>GUI Development'),
    ...
    (0, 'Reference · The Card, the List and the Cram Sheet',
        'Reference', 'The Card, the List<br>and the Cram Sheet'),
    (2, 'R.1 · The Python Reference Card',
        'Reference &middot; R.1', 'The Python Reference Card'),
    (2, 'R.2 · The Must-Memorise List',
        'Reference &middot; R.2', 'The Must-Memorise List'),
    (2, 'R.3 · Exam Day Strategy',
        'Reference &middot; R.3', 'Exam Day Strategy'),
    (2, 'R.4 · The Trap Index and Cram Sheet',
        'Reference &middot; R.4', 'The Trap Index and Cram Sheet'),
    ...
    (0, 'Objective Section · Seventy Questions, Every Option Explained',
        'Objective Section', 'Seventy Questions,<br>Every Option Explained'),
    (2, 'How to Attack an Objective Question',
        'Objective Section', 'How to Attack an Objective Question'),
    (2, 'Introduction to Python Programming',
        'Objective Section', 'Introduction to Python Programming'),
    (2, 'Python Basics, Syntax, Operators and Strings',
        'Objective Section', 'Python Basics, Syntax, Operators and Strings'),
    (2, 'Control Flow, Lists, Tuples, Sets and Dictionaries',
        'Objective Section', 'Control Flow, Lists, Tuples, Sets and Dictionaries'),
    (2, 'Functions, Modules, Files and Exceptions',
        'Objective Section', 'Functions, Modules, Files and Exceptions'),
    (2, 'Databases and GUI Development',
        'Objective Section', 'Databases and GUI Development'),
