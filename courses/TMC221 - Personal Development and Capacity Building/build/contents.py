...
TOC = [
    ...
    (1, 'The course at a glance', 'Orientation', 'The course at a glance'),

    (0, 'Module One · Goal Setting and Personal Accomplishment',
        'Module One', 'Goal Setting and<br>Personal Accomplishment'),
    (2, 'Unit 1 · What a Goal Really Is', 'Module One &middot; Unit 1', 'What a Goal Really Is'),
    (2, 'Unit 2 · Four Frameworks That Work', 'Module One &middot; Unit 2', 'Four Frameworks That Work'),
    (2, 'Unit 3 · The Psychology of Achievement', 'Module One &middot; Unit 3', 'The Psychology of Achievement'),
    (2, 'Unit 4 · Total Man and Goal Architecture', 'Module One &middot; Unit 4', 'Total Man and Goal Architecture'),

    (0, 'Module Two · Positive Thinking and Creative Problem-Solving',
        'Module Two', 'Positive Thinking and<br>Creative Problem-Solving'),
    (2, 'Unit 1 · Wisdom and Inner Architecture', 'Module Two &middot; Unit 1', 'Wisdom and Inner Architecture'),
    (2, 'Unit 2 · Spirit and Execution', 'Module Two &middot; Unit 2', 'Spirit and Execution'),

    (0, 'Module Three · Personal Branding and Strategic Positioning',
        'Module Three', 'Personal Branding and<br>Strategic Positioning'),
    (2, 'Unit 1 · The Inner Brand', 'Module Three &middot; Unit 1', 'The Inner Brand'),
    (2, 'Unit 2 · Packaging, Positioning and Presence', 'Module Three &middot; Unit 2', 'Packaging, Positioning and Presence'),

    (0, 'Module Four · Systems for Sustainable Success',
        'Module Four', 'Systems for<br>Sustainable Success'),
    ...
    (0, 'Rapid Recall · The Master Cram Sheet', 'Rapid Recall', 'The Master Cram Sheet'),
]
