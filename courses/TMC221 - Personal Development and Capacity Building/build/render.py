...
FOOTER = (
    ...
    '<span>TMC221 · Personal Development and Capacity Building · Victor Ayodeji</span>'
...
with sync_playwright() as p:
    ...
    # This course has NO monospace content, so 'DejaVu Sans Mono' is declared but
    # never used, and an unused @font-face never loads (check() would be false).
    # Verify only the two families the manual actually sets text in.
    faces = pg.evaluate("""() => {
        const want = ['DejaVu Sans', 'DejaVu Serif'];
