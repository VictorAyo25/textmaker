...
BODY_PARTS = ['front.html', 'module1.html', 'module2.html', 'module2_unit34.html',
              'module3.html', 'module4.html', 'module5.html', 'module5_sql.html',
              'paper2526.html',
...
<head>
<meta charset="utf-8">
<title>DTS224 - Data Management I - Study Manual</title>
...
def main():
    ...
    out = os.path.join(HERE, 'DTS224_checkpoint.pdf')
