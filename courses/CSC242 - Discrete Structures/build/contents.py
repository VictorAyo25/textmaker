...
TOC = [
    ...
    (0, 'Part Eleven · Programming for Discrete Structures', 'Part Eleven', 'Programming for<br>Discrete Structures'),
    (2, '11.1 · Enough Python to Answer the Question', 'Part Eleven &middot; 11.1', 'Enough Python to Answer the Question'),
    (2, '11.2 · The Same Tools in C++', 'Part Eleven &middot; 11.2', 'The Same Tools in C++'),
    (2, '11.3 · The Four Examined Programs, in Python and C++', 'Part Eleven &middot; 11.3', 'The Four Examined Programs, in Python and C++'),
