...
TOC = [
    ...
    (0, 'Module One · Systems, Analysts and the Life Cycle',
        'Module One', 'Systems, Analysts<br>and the Life Cycle'),
    (2, 'Unit 1 · Systems Analysis and the Systems Analyst', 'Module One &middot; Unit 1', 'Systems Analysis and the Systems Analyst'),
    (2, 'Unit 2 · The System Development Life Cycle', 'Module One &middot; Unit 2', 'The System Development Life Cycle'),
    (2, 'Unit 3 · Methodologies, Feasibility and Approaches', 'Module One &middot; Unit 3', 'Methodologies, Feasibility and Approaches'),

    (0, 'Module Two · Requirements: Discovery and Modelling',
        'Module Two', 'Requirements: Discovery and Modelling'),
    (2, 'Unit 1 · Fact-Finding and Requirements', 'Module Two &middot; Unit 1', 'Fact-Finding and Requirements'),
    (2, 'Unit 2 · Use Case Modelling', 'Module Two &middot; Unit 2', 'Use Case Modelling'),

    (0, 'Module Three · Process and Data Flow Modelling',
        'Module Three', 'Process and Data Flow Modelling'),
    (2, 'Unit 1 · Data Flow Diagrams', 'Module Three &middot; Unit 1', 'Data Flow Diagrams'),

    (0, 'Module Four · Data Modelling with Entity-Relationship Diagrams',
        'Module Four', 'Data Modelling with<br>Entity-Relationship Diagrams'),
    (2, 'Unit 1 · The Entity-Relationship Model', 'Module Four &middot; Unit 1', 'The Entity-Relationship Model'),

    (0, 'Module Five · Object-Oriented Modelling with UML',
        'Module Five', 'Object-Oriented Modelling with UML'),
    (2, 'Unit 1 · UML and Class Diagrams', 'Module Five &middot; Unit 1', 'UML and Class Diagrams'),
    (2, 'Unit 2 · Object-Oriented Design Concepts', 'Module Five &middot; Unit 2', 'Object-Oriented Design Concepts'),
    (2, 'Unit 3 · Activity and Sequence Diagrams', 'Module Five &middot; Unit 3', 'Activity and Sequence Diagrams'),

    (0, 'Module Six · Design, Architecture and Delivery',
        'Module Six', 'Design, Architecture and Delivery'),
    (2, 'Unit 1 · System Design and Architecture', 'Module Six &middot; Unit 1', 'System Design and Architecture'),
    (2, 'Unit 2 · Project Management, Installation and Support', 'Module Six &middot; Unit 2', 'Project Management, Installation and Support'),

    (0, 'Reference · The Notation Legend and Must-Memorise List',
        'Reference', 'The Notation Legend<br>and Must-Memorise List'),
    (2, 'The Notation Legend', 'Reference &middot; One', 'The Notation Legend'),
    (2, 'The Must-Memorise List', 'Reference &middot; Two', 'The Must-Memorise List'),

    (0, 'Worked Paper 2025/2026', 'Worked Paper 2025/2026', 'The 2025/2026 Paper,<br>Fully Worked'),
    (2, 'Section A: Questions One and Two', 'Worked Paper 2025/2026', 'Section A: Questions One and Two'),
    (2, 'Section B: Questions Three to Six', 'Worked Paper 2025/2026', 'Section B: Questions Three to Six'),

    (0, 'Worked Paper 2024/2025', 'Worked Paper 2024/2025', 'The 2024/2025 Paper,<br>Fully Worked'),
    (2, 'Section A: Questions One and Two', 'Worked Paper 2024/2025', 'Section A: Questions One and Two'),
    (2, 'Section B: Questions Three to Six', 'Worked Paper 2024/2025', 'Section B: Questions Three to Six'),

    (0, 'Objective Section · Both Class Tests, Every Option Explained',
        'Objective Section', 'Both Class Tests,<br>Every Option Explained'),
    (2, 'How to Attack an Objective Question',
        'Objective Section', 'How to Attack an Objective Question'),
    (2, 'Module One, the Analyst, the Life Cycle and Methodologies',
        'Objective Section', 'Module One, the Analyst, the Life Cycle and Methodologies'),
    (2, 'Module Two, Fact-Finding and Use Cases',
        'Objective Section', 'Module Two, Fact-Finding and Use Cases'),
    (2, 'Module Three, Data Flow Diagrams',
        'Objective Section', 'Module Three, Data Flow Diagrams'),
    (2, 'Module Four, the Entity-Relationship Model',
        'Objective Section', 'Module Four, the Entity-Relationship Model'),
    (2, 'Module Five, Object Orientation and UML',
        'Objective Section', 'Module Five, Object Orientation and UML'),
    (2, 'Module Six, Design, Architecture and Delivery',
        'Objective Section', 'Module Six, Design, Architecture and Delivery'),
...
FULL_TOC_PLAN = """
  Module One   Systems, Analysts and the Life Cycle: U1 Systems Analysis and the
               Systems Analyst, U2 The System Development Life Cycle, U3
               Methodologies, Feasibility and Approaches
  Module Two   Requirements: Discovery and Modelling: U1 Fact-Finding and
               Requirements, U2 Use Case Modelling
  Module Three Process and Data Flow Modelling: U1 Data Flow Diagrams
  Module Four  Data Modelling with Entity-Relationship Diagrams: U1 The
               Entity-Relationship Model (cardinality, notation styles, reading ERDs)
  Module Five  Object-Oriented Modelling with UML: U1 UML and Class Diagrams,
               U2 Object-Oriented Design Concepts, U3 Activity and Sequence Diagrams
  Module Six   Design, Architecture and Delivery: U1 System Design and Architecture,
               U2 Project Management, Installation and Support
  Reference    Notation cheat-sheets and the must-memorise consolidation
  Worked Papers 2025/2026 (target) and 2024/2025, fully worked
  Mock Examination One / Two / Three (question paper + answers), leaning 25/26
"""
